    ...
    :wxWindow(parent, id, pos, size)
{
    ...
    signInButton = new CustomButton(this, wxSize(100, 30), *appSetting->order6, appSetting->selected_language[AppSetting::TextKeys::Login], true, labelFont, *appSetting->order3, false);
    dontHaveAnAccount = new CustomButton(this, wxDefaultSize, this->GetBackgroundColour(), appSetting->selected_language[AppSetting::TextKeys::DontHaveAnAccount], false, labelFont, *appSetting->order3, true);
